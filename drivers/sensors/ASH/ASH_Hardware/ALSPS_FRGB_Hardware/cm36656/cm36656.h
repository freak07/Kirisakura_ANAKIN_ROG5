...
#define CM36656_PROXIMITY_THDL_DEFAULT  	(38)
#define CM36656_PROXIMITY_THDH_DEFAULT  	(55)
#define CM36656_PROXIMITY_INF_DEFAULT  		(30)
#define CM36656_PROXIMITY_AUTOK_MIN  		(3)
#define CM36656_PROXIMITY_AUTOK_MAX  		(250)
#define CM36656_LIGHT_CALIBRATION_DEFAULT   (1379)
