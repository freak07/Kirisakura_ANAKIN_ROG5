...
static uint16_t g_reg_addr = 0x84; //VCM addr
...
static const struct file_operations actuator_read_vcm_eeprom_fops = {
		.owner = THIS_MODULE,
		.open = actuator_read_vcm_eeprom_open,
		.read = seq_read,
		.llseek = seq_lseek,
		.release = single_release,
};
...
static const struct file_operations actuator_read_vcm_set_fops = {
		.owner = THIS_MODULE,
		.open = actuator_read_vcm_set_open,
		.read = seq_read,
		.llseek = seq_lseek,
		.release = single_release,
};
